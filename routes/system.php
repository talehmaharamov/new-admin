...
Route::group(['middleware' => 'auth:admin', 'as' => 'system.'], function () {
    ...
    Route::get('creation/', [App\Http\Controllers\Backend\System\CreationController::class, 'index'])->name('creation.index');
    Route::post('creation/store', [App\Http\Controllers\Backend\System\CreationController::class, 'store'])->name('creation.store');
    ...
    Route::group(['name' => 'delete'], function () {
        ...
        Route::get('/report/{id}/delete', [App\Http\Controllers\Backend\System\ReportController::class, 'delete'])->name('reportsDelete');
        Route::get('/report/clean-all', [App\Http\Controllers\Backend\System\ReportController::class, 'clean'])->name('cleanAllReport');
