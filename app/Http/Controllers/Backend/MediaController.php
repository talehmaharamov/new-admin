...
class MediaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $media = new Media();
            $media->photo = uploadImage('media', $request->file('photo'));
            $media->save();
            ...
            foreach (uploadMultipleImages('media', $request->file('photos')) as $photo) {
