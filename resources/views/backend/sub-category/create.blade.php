        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.sub-categories.store') }}" class="needs-validation"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('backend.sub-categories')</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="altCategory">
                                                @foreach($altCategories as $alt)
                                                    <option
                                                        value="{{ $alt->id }}"> {{ $alt->translate(app()->getLocale())->name ?? '-' }} ({{  ( $alt->category()->first()->translate(app()->getLocale())->name ?? '-' ) }})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
