                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.alt-categories'):</h4>
                                <a href="{{ route('backend.alt-categories.create') }}" class="btn btn-primary mb-3"><i
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.alt-categoriesDelete',['id'=>$category->id]) }}">
